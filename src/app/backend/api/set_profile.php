...
//transforming json object to normal php format
  ...
  if ($connected){
    ...
    $query->bindParam(':phone_number', $data['phoneNumber']);
    ...
    if($query->rowCount() > 0 ){
      ...
      $sql2 = "INSERT INTO profiles (fullname, phone_number, street, city, state, zip_code, added_date, last_modified, status)
