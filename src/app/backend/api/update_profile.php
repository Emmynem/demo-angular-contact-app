<?php
  ...
  if ($connected){
    ...
    if($query->rowCount() >= 0 ){
      ...
      $sql2 = "UPDATE runners SET fullname=:fullname, phone_number=:phone_number, street=:street, city=:city, state=:state, zip_code=:zip_code, last_modified=:last_modified WHERE id=:id";
